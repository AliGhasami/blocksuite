...
export const mahdaadDatabaseBlockHtmlAdapterMatcher: BlockHtmlAdapterMatcher = {
          ...
          const rowCells = Array.prototype.map.call(columns, col => {
            ...
            switch (col.type) {
              ...
              case 'checkbox': {
                ...
                return createAstTableCell([
                  { type: 'raw', value: cell.value ? checkboxChecked().strings[0] : checkboxUnchecked().strings[0] },
                ]);
              }
              default:
                return createAstTableCell([
...
export const MahdaadDatabaseBlockHtmlAdapterExtension = BlockHtmlAdapterExtension(
